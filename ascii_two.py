...
if __name__ == '__main__':
    ...
    # （1）
    # getpixel()
    # 函数接受一个元组作为输入参数，该元组为一个二维坐标，函数将返回该坐标处像素点的RGB三个值。
    # （有时候还会返回RGBA四个值，这取决于图片的彩色模型。也正是因此，我们此处采取切片的方式，
    # 即[:3]，来保证select_ascii_char函数恰好只接收到3个参数）
    # 我们还要注意到，此处的im.getpixel((w, h))[:3]
    # 前面有一个星号，即 *，这里涉及的语法点是“可变参数”，详情参见
